  ...
  // PART 1: 概念篇 - 裝修房子的魔法 (1-7)
  {
    ...
    contentHtml: `
      <div class="layout-title">
        ...
        <div class="author-info" style="margin: 2.5rem auto 0 auto; text-align: center; font-size: 1.1rem; line-height: 1.8; color: var(--text-secondary); border-top: 1px solid var(--card-border); padding-top: 1.5rem; width: 300px;">
          <p>國立臺灣師範大學 鍾明倫</p>
          <p>2026.07.08</p>
        </div>
      </div>
